...
(() => {
  ...
  var _sfc_render$4 = function render() {
    ...
    return _setup.showImageList ? _c2("div", [_c2("wf-layout", _vm._l(_setup.store.imageList, function(image, index) {
      return _c2("v-card", { key: index, staticClass: "mb-2 posts-image-card", style: _setup.maxHeightStyle }, [_setup.store.settings.masonryLayout === "flexbin" ? _c2("div", [_c2("img", { staticClass: "post-image", attrs: { "alt": "", "loading": "lazy", "src": _setup.getImgSrc(image) }, on: { "click": function($event) {
